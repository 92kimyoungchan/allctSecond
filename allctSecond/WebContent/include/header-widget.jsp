...
<!-- <div id="floatMenu">
	<ul>
		<li><a href=""><img
				src="/allctSecond/assets/images/icn_quick1.png"><span>메뉴1</span></a></li>
		<li><a href=""><img
				src="/allctSecond/assets/images/icn_quick4.png"><span>메뉴2</span></a></li>
		<li><a href=""><img
				src="/allctSecond/assets/images/icn_quick5.png"><span>메뉴3</span></a></li>
	</ul>
			...
			<div class="row-noneflex">
				...
				<ul class="ul-theory">
					...
					<li><a href="/allctSecond/recruit/recruit.jsp">모집공고</a>
						<ul class="drop-menu">
							<li><a href="/allctSecond/recruit/recruit.jsp">공고보기</a></li>
						...
						<div class="uber-section">
							<ul class="uber-menu">
								...
								<li class="uber-column">
									<ul>
										<li><div>
												<p><a href="/allctSecond/recruit/recruit.jsp">공고보기</a></p>
											</div></li>
							...
							<li><a href="/allctSecond/info/infoAcademy.jsp">학술정보</a></li>
								...
								<li class="uber-column">
									<ul>
										<li><div>
												<p><a href="/allctSecond/board/board_notice.jsp">공지사항</a></p>

											</div></li>
										
							<li><a href="/allctSecond/board/board_news.jsp">교육 및 뉴스</a></li>
