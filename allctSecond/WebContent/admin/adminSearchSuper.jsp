														...
														<li>
															<div class="consent">
																<label class="labelCheck" for="state-all"><input
																	type="checkbox" id="state-all" value="" name=""
																	class="" /><span class="checkmark"></span> <span>전체</span>
																</label>
														...
														<li>
															<div class="consent">
																<label class="labelCheck" for="state-ing"><input
																	type="checkbox" id="state-ing" value="" name=""
																	class="inputHeader" /> <span class="checkmark"></span>
																	<span>진행중</span> </label>
														...
														<li>
															<div class="consent">
																<label class="labelCheck" for="state-stop"><input
																	type="checkbox" id="state-stop" value="" name=""
																	class="inputHeader" /> <span class="checkmark"></span>
																	<span>중지</span> </label>
														...
														<li>
															<div class="consent">
																<label class="labelCheck" for="state-active"><input
																	type="checkbox" id="state-active" value="" name=""
																	class="inputHeader" /> <span class="checkmark"></span>
																	<span>모집중</span> </label>
														...
														<li>
															<div class="consent">
																<label class="labelCheck" for="state-complete"><input
																	type="checkbox" id="state-complete" value="" name=""
																	class="inputHeader" /> <span class="checkmark"></span>
																	<span>완료</span> </label>
												...
												<div class="am-h-row-right">
													<div class="admin-calender-form">
														<span class="admin-calender-form-span">시작</span> <input
															type="text" name="" id="" class="datepicker"> <span
															class="admin-calender-form-span"> <i
														...
														<li>
															<div class="consent">
																<label class="labelCheck" for="location-etc"><input
																	type="checkbox" id="location-etc" value="" name=""
																	class="" /> <span class="checkmark"></span> <span>그
																		외</span> </label>
											...
											<div class="am-h-state-wrap">
												...
												<div class="am-h-row-right">
													...
													<ul class="am-h-state">
														<li class="radio">
															<div class="consent">
																<label class="labelRadio" for="inputCheck5">남성<input
																	type="radio" id="inputCheck5" name="sex" value="남성" />
														...
														<li class="radio">
															<div class="consent">
																<label class="labelRadio" for="inputCheck6">여성<input
																	type="radio" id="inputCheck6" name="sex" value="여성" />
																	<span class="checkmark"></span></label>
														...
														<li class="radio">
															<div class="consent">
																<label class="labelRadio" for="inputCheck7">성별무관<input
																	type="radio" id="inputCheck7" name="sex" value="성별무관" />
																	<span class="checkmark"></span></label>
															</div>
														</li>
													</ul>
											...
											<div class="am-h-state-wrap">
												...
												<div class="am-h-row-right">
													<ul class="am-h-state">
														<li class="radio">
															<div class="consent">
																<label class="labelRadio" for="inputCheck9">건강인<input
																	type="radio" id="inputCheck9" name="recipient"
																	value="건강인" /> <span class="checkmark"></span></label>
														...
														<li class="radio">
															<div class="consent">
																<label class="labelRadio" for="inputCheck8">질환자<input
																	type="radio" id="inputCheck8" name="recipient"
																	value="질환자" /> <span class="checkmark"></span></label>

															</div>
														</li>
														<li class="radio"><label class="labelRadio"
															for="inputCheck10">질환무관<input type="radio"
																id="inputCheck10" name="recipient" value="질환무관" /> <span
											...
											<div class="am-h-state-wrap">
												...
												<div class="am-h-row-right">
													<ul class="am-h-state test-kinds-ul">
														<li class="radio"><label class="labelRadio"
															for="inputCheck11">임상시험<input type="radio"
																id="inputCheck11" name="type" value="임상시험" /> <span
																class="checkmark"></span></label></li>
														<li class="radio"><label class="labelRadio"
															for="inputCheck12">생동성<input type="radio"
																...
																class="checkmark"></span></label></li>
														<li class="radio"><label class="labelRadio"
															for="inputCheck13">모두포함<input type="radio"
																id="inputCheck13" name="recipient" value="모두포함" /> <span
																class="checkmark"></span></label></li>
													</ul>
												</div>
											</div>
