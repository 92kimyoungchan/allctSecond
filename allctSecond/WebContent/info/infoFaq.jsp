...
<body>
					...
					<div class="board-faq">
						...
						<div class="content">
							...
							<p>
								...
								치료가 되지 않을 수 있습니다.<br> 3) 연구 기관의 방문, 잦은 치료 및 입원, 약을 복용하는 방법이
								복잡할 수도 있습니다.
							</p>
						</div>
						...
						<button class="collapsible">
							<span>Q</span>
							<p>임상연구 참여로 인한 이익 및 위험은 무엇입니까?</p>
						</button>
						<div class="content">
							<p>A</p>
							<p>
						...
						<button class="collapsible">
							<span>Q</span>
							<p>임상연구 참여 후 대상자는 중간에 동의철회 할 수 있습니까?</p>
						</button>
						<div class="content">
							<p>A</p>
							<p>
	...
	<script>
		$(document).ready(function() {
			...
			$('.board-faq').find('.is-checked').removeClass('is-checked');
			$('.board-faq > .collapsible:eq(3)').addClass('is-checked');
			$('.board-faq > .collapsible>p:eq(3)').addClass('is-checked');
